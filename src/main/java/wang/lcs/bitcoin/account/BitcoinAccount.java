...
public class BitcoinAccount {
	...
	private final BitcoinAccountConfig config;
	private final byte[] privateKey;
	private byte[] publicKey;

	public static BitcoinAccount createBitcoinAccount(BitcoinAccountConfig config) {
		return new BitcoinAccount(config);
	}

	private BitcoinAccount(BitcoinAccountConfig config) {
		this(null, config);
	}

	public BitcoinAccount(byte[] privateKey, BitcoinAccountConfig config) {
		if (privateKey == null) {
